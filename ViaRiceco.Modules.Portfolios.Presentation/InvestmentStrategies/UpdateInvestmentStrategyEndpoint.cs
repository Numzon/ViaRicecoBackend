...
using ViaRiceco.Modules.Portfolios.Application.InvestmentStrategies.UpdateInvestmentStrategy;
...
internal sealed class UpdateInvestmentStrategyEndpoint(ISender sender, IHyperlinkService hyperlinkService, IDataShapingService dataShapingService)
    : Ep.Req<UpdateInvestmentStrategyEndpoint.Request>.Res<Result<InvestmentStrategyDto>>
{
    [UsedImplicitly]
    ...
    {
        var command = new UpdateInvestmentStrategyCommand(req.Id, req.UninvestedAmount);
