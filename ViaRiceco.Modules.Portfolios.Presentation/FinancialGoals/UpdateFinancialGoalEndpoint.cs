...
internal sealed class UpdateFinancialGoalEndpoint(ISender sender, IHyperlinkService hyperlinkService, IDataShapingService dataShapingService)
    : Ep.Req<UpdateFinancialGoalEndpoint.Request>.Res<Result<FinancialGoalDto>>
{
    [UsedImplicitly]
    ...
    {
        var command = new UpdateFinancialGoalCommand(req.Id, req.Name, req.ParentId);
