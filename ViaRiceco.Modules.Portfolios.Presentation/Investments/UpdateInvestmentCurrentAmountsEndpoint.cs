...
internal sealed class UpdateInvestmentCurrentAmountsEndpoint(ISender sender, IHyperlinkService hyperlinkService, IDataShapingService dataShapingService)
    : Ep.Req<UpdateInvestmentCurrentAmountsEndpoint.Request>.Res<Result<InvestmentStrategyDto>>
{
    [UsedImplicitly]
