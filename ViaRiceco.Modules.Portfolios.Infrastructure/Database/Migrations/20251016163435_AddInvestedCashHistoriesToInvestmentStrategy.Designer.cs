...
namespace ViaRiceco.Modules.Portfolios.Infrastructure.Database.Migrations
{
    ...
    [Migration("20251016163435_AddInvestedCashHistoriesToInvestmentStrategy")]
    partial class AddInvestedCashHistoriesToInvestmentStrategy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ViaRiceco.Modules.Portfolios.Domain.InvestedCashHistories.InvestedCashHistory", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("ViaRiceco.Modules.Portfolios.Domain.InvestedCashHistories.InvestedCashHistory", b =>
                {
                    b.HasOne("ViaRiceco.Modules.Portfolios.Domain.InvestmentStrategies.InvestmentStrategy", null)
                        .WithMany("InvestedCashHistories")
                        .HasForeignKey("InvestmentStrategyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_invested_cash_histories_investment_strategies_investment_st");
                });
            ...
            modelBuilder.Entity("ViaRiceco.Modules.Portfolios.Domain.InvestmentStrategies.InvestmentStrategy", b =>
                {
                    b.Navigation("InvestedCashHistories");
